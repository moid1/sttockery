                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div class="user-details">
                        ...
                        <div class="user-info">
                            ...
                            <span class="text-muted user-status"><i class="fa fa-dot-circle-o text-success"></i> {{Auth::user()->type == '1' ? 'Manager' : 'Admin'}}</span>
                        </div>
                        @endauth
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            {{-- <li class="has_sub">
                             ...
                             <li>
                                <a href="{{route('change-password')}}" class="waves-effect"><i class="mdi mdi-calendar-check"></i><span> Change Password </span></a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    <a class="nav-link dropdown-toggle arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button"
                                       aria-haspopup="false" aria-expanded="false">
                                        {{-- <img src="{{asset('dashboard/assets/images/users/avatar-1.jpg')}}" alt="user" class="rounded-circle"> --}}
                                    </a>
